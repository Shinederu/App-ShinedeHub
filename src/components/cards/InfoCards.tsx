  ...
  return (
    <div className="mb-6 inline-block w-full border-b-4 border-[#6b6b6b] pb-8">
      <div className="grid grid-cols-1 gap-5 sm:gap-8 lg:grid-cols-2">
        <div className="flex flex-col items-start rounded-lg border-2 border-[#6a11cb] bg-[#10101f] p-5 animate-fade-in-up sm:p-6">
          <div>
        ...
        <div className="flex flex-col items-start rounded-lg border-2 border-[#cb1111] bg-[#10101f] p-5 animate-fade-in-up sm:p-6">
          <div>
